...
\newacronym[
  description={The lowest part of Earth’s atmosphere, directly influenced by the Earth’s surface}
]{abl}{ABL}{Atmospheric Boundary Layer}

\newacronym[
  description={File format to store 3D models that consists of vertices, edges, wires, faces, shells, solids, etc.}
...
\newacronym[
  description={Digital representation of terrain elevation that consists of a regular grid of elevation z-values}
...
\newacronym[
  description={Total one-sided leaf area per unit volume within a plant canopy}
]{lad}{LAD}{Leaf Area Density}

\newacronym[
  description={Total one-sided leaf area per unit of ground area within a plant canopy}
...
\newacronym[
  description={Statistical metric that quantifies the average deviation between predicted and observed values}
]{mbe}{MBE}{Mean Bias Error}

\newacronym[
  description={Statistical metric that measures the average squared difference between predicted and observed values}
...
\newacronym[
  description={Time-averaged equations of motion for fluid flow}
]{rans}{RANS}{Reynolds-Averaged Navier-Stokes}

\newacronym[
  description={Statistical metric that measures the average difference between predicted and observed values}
]{rmse}{RMSE}{Root Mean Squared Error}

\newacronym[
  description={Statistical metric that measures the average measures the average magnitude of error}
...
\newacronym[
  description={Average temperature of all surfaces surrounding a person}
...
\newacronym[
  description={Phenomenon where urban areas are hotter than rural areas due to materials and human activities}
...
\newacronym[
  description={Physiological comfort of human body index}
